//
//  AlbumCartViewListRow.swift
//  AirBnbAssignment
//
//  Created by Jithin M on 01/09/20.
//  Copyright © 2020 Jithin M. All rights reserved.
//

import SwiftUI

struct AlbumCartViewListRow: View {
...
struct AlbumCartViewListRow_Previews: PreviewProvider {
    static var previews: some View {
        AlbumCartViewListRow(album: AlbumViewModel(album: Album(artistName: "Artist Name", trackName: "Track Name", collectionName: "Collection Name", collectionPrice: 12, releaseDate: "ReleaseDate", artworkUrl100: "")))
    }
}
